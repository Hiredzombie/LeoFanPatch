...
unk "\"{cps=22}{font=ui/COLONNA.ttf}{i}-You really fell for that?{/i}\""
...
if leo == "kit":
    ku "\"A fucked up one, apparently. Anyway, I went over to Leo's house to see if he was home, but no one was there...\""
show Kudzu Depressed with dis
...
"Is this what it was like for all those people living in the town a hundred years ago?"
...
ku "\"You ok—\""
"And then a much bigger paw comes out from behind me, pushing Kudzu's arm aside as I'm pulled back into a tight hug."
...
if leo == "fro":
    "It's broken."
if leo == "kit":
    "A light shines from his bedroom window."
show Kudzu Annoyed with dis
ku "\"Shit.\""
